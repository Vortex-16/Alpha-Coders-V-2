        ...
        <div ref={container} className="space-y-6">
            {events.map((event, i) => (
                <div key={i} className="event-card group flex flex-col sm:flex-row gap-6 p-6 rounded-2xl border border-neutral-200 dark:border-white/10 bg-white/50 dark:bg-white/5 hover:bg-neutral-100 dark:hover:bg-white/10 transition-colors backdrop-blur-sm shadow-sm hover:shadow-md">
                    <div className="flex-shrink-0 flex flex-col items-center justify-center p-4 rounded-xl bg-blue-500/10 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 w-20 h-20">
                    ...
                    <div className="flex-grow space-y-2">
                        <div className="flex justify-between items-start">
                            <h3 className="text-xl font-bold text-neutral-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors">{event.title}</h3>
